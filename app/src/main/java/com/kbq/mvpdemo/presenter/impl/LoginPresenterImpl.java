package com.kbq.mvpdemo.presenter.impl;
...
import com.kbq.mvpdemo.model.impl.LoginModelImpl;
import com.kbq.mvpdemo.presenter.LoginPresenter;

/**
 * Created by KBQ on 16/6/7.
 * 1.完成presenter的实现。这里主要是Model层和View层的交互和操作
 * 2.presenter里面还有个OnLoginFinishedListener，
 *   其在Presenter层实现，给Model层回调，更改View层状态，
 *   确保Model层不直接操作View层。如果没有这一接口在LoginPresenterImpl实现的话，
